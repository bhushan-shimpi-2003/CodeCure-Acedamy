      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
        ...
        >
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            Coducure Academy was founded with a singular goal: to bridge the gap between manual testing and elite software development in test (SDET). We don't just teach tools; we build strong engineering foundations.
          </p>
          <p className="text-slate-600 text-lg leading-relaxed">
