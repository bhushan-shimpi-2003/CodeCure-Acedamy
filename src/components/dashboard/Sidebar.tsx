...
import { LayoutDashboard, PlayCircle, FileText, Briefcase, MessageSquare, X, LogOut, Terminal } from "lucide-react";
    ...
    <>
      ...
      >
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-none transition-all duration-200 uppercase text-sm font-bold ${
                  isActive 
        ...
        <div className="p-4 border-t border-emerald-500/30">
          <Link to="/" className="flex items-center gap-3 px-4 py-3 rounded-none text-slate-400 hover:bg-[#111] hover:text-red-500 transition-all duration-200 uppercase text-sm font-bold border border-transparent hover:border-red-500/30">
