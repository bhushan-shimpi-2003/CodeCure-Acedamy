...
import { LayoutDashboard, Users, FileText, Video, MessageSquare, X, LogOut, Terminal } from "lucide-react";
import { Link } from "react-router-dom";

export default function TeacherSidebar({ activeTab, setActiveTab, isOpen, setIsOpen }: any) {
  const navItems = [
    { id: "overview", label: "Course_Management", icon: LayoutDashboard },
    { id: "courses", label: "Active_Courses", icon: FileText },
    { id: "students", label: "Student_List", icon: Users },
    { id: "assignments", label: "Assignment_Panel", icon: FileText },
    { id: "interviews", label: "Mock_Interviews", icon: Video },
    { id: "doubts", label: "Doubt_Support", icon: MessageSquare },
  ];
        ...
        <div className="p-6 flex items-center justify-between border-b border-emerald-500/30">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="font-bold text-xl tracking-tight text-white uppercase">
              Instructor<span className="text-emerald-500 animate-pulse">_</span>
            </span>
          </Link>
