      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-emerald-500/30">
          <div className="hidden md:block text-right">
            <p className="text-sm font-bold text-emerald-400 uppercase">Rahul_Shetty</p>
            <p className="text-xs text-emerald-600 uppercase">Lead_Instructor</p>
          </div>
