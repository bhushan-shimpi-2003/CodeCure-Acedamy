...
const testimonials = [
  ...
  },
  {
    ...
    text: "The best part of Codecure Acedamy is the 1-on-1 mentorship. Rahul sir's way of explaining complex JS concepts made automation feel easy. Highly recommended!",
